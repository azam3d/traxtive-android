...
//                    database.reference.child("motorcycles-v2").child(userId).child(key).setValue(motor)
//                }
////                addMotor(userId)
//                return@lit
//            }
...
//
////                    database.reference.child("userProfile-v2").child(userId).setValue(profile) // remove userId
//                }
//                return@lit
//            }
...
//
////                        database.reference.child("serviceUpdate-v2").child(userId).child(motorId).setValue(serviceUpdate) // remove motorId
//                    }
//                }
//                return@lit
//            }
